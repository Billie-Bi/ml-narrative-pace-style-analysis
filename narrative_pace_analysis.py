...
plt.subplot(1, 2, 1)
sns.boxplot(x='part', y='scaled_event_density', data=chapter_df, palette='viridis', order=part_order, showmeans=True, meanprops={'marker': '^', 'markerfacecolor': 'lime', 'markeredgecolor': 'black'})
plt.title("Event Density by Part")
plt.xlabel("Narrative Part")
plt.ylabel("Standardized Event Density")
plt.subplot(1, 2, 2)
sns.boxplot(x='part', y='scaled_perspective_shift', data=chapter_df, palette='viridis', order=part_order, showmeans=True, meanprops={'marker': '^', 'markerfacecolor': 'lime', 'markeredgecolor': 'black'})
